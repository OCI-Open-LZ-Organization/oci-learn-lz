...
| 4 | Review configurations. First review what is [possible to configure](/exercise1/diagrams/oci_iam_config_all_variables.jpg) and then review the [exercise specific configurations](/exercise1/diagrams/oci_iam_config_exercise_variables.jpg) scope. These views are also available on the draw.io tabs. |
| 5 | Review the tenancy structure configuration in you **[local user folder](/users/)**  **oci_learn_lz_iam.yml** file. |
...
| ACTIVITY | DESCRIPTION   | 
|---|---|
| 1 | Push your local changes on the **oci_learn_lz_iam.yml** to your **[remote user folder](/users/)** in the **OCI-LEARN-LZ-OPS-REPO main branch**. </br>The image below is a high-level representations of this. |
