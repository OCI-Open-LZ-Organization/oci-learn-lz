...
| 4 | Review configurations. First review what is [possible to configure](/exercise2/diagrams/oci_network_config_all_variables.jpg) and then review the [exercise specific configurations](/exercise2/diagrams/oci_network_config_exercise_variables.jpg) scope. These views are also available on the draw.io tabs. |
| 5 | Review the network structure configuration in you **[local user folder](/users/)**  **oci_learn_lz_network.yml** file. |
